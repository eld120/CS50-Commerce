    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction_end', models.DateTimeField(blank=True, default=datetime.datetime(2021, 3, 30, 12, 39, 51, 821460), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('listing_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='auctions.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Bid',
